...
namespace Creaturia.Common
{
    public static class TestSets
    {

        public static readonly bool[] Hallowed = NPCID.Sets.Factory.CreateBoolSet(false, NPCID.Unicorn,
           NPCID.Pixie,
        ...
        public static readonly bool[] Fiery = NPCID.Sets.Factory.CreateBoolSet(false,
       NPCID.FireImp,
       NPCID.LavaSlime,
       NPCID.Hellbat,
       NPCID.Demon,
       ...
       NPCID.RedDevil);
          ...
          public static readonly bool[] Evil = NPCID.Sets.Factory.CreateBoolSet(false, NPCID.CorruptBunny, NPCID.Corruptor, NPCID.EaterofSouls, NPCID.EaterofWorldsBody, NPCID.EaterofWorldsHead, NPCID.EaterofWorldsTail, NPCID.DevourerBody
      ...
      //  private static bool[] _evilInitialized;

        


                public static readonly bool[] Jungle = NPCID.Sets.Factory.CreateBoolSet(false, NPCID.JungleSlime, NPCID.SpikedJungleSlime, NPCID.PlanterasTentacle, NPCID.PlanterasHook,
                ...
                public static readonly bool[] HurtingBeesTest = NPCID.Sets.Factory.CreateBoolSet(false, 210, 211, 222);
