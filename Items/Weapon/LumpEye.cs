...
namespace Creaturia.Items.Weapon
{
	...
	{
		private const string ChainTexturePath = "Creaturia/Items/Weapon/LumpEyeChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "Creaturia/Items/Weapon/LumpEyeChainExtra";  // This texture and related code is optional and used for a unique effect
		...
		public override void AI()
		{
			...
			float forcedRetractAcceleration = 8f; // How quickly the projectile will accelerate back towards the player while being forced to retract
			...
			*/
			...
			if (Main.rand.NextBool(dustRate))
				Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.IchorTorch, 0f, 0f, 150, default(Color), 1.3f);
		}
