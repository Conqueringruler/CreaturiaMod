...
namespace Creaturia.Buffs
{
    public class SlipperyBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            {
                var dust = Dust.NewDustDirect(player.Center + new Vector2(Main.rand.Next(-5, 5), Main.rand.Next(-5, 5)), player.width, player.height, DustID.Water, player.velocity.X, player.velocity.Y, 100, Color.DarkGray, 1);
                dust.velocity.Y /= 10;
