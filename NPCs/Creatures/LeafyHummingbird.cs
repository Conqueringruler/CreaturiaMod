...
namespace Creaturia.NPCs.Creatures
{
    ...
    internal class LeafyHummingbird : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPC.catchItem = (short)ItemType<LeafyHummingbirdItem>();
	...
	internal class LeafyHummingbirdItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Ruby-Throated Hummingbird");
		...
		{ 
			...
			Item.makeNPC = (short)NPCType<LeafyHummingbird>();
		}
	}
}