...
namespace Creaturia.NPCs.Creatures
{
    ...
    internal class HummingBird2 : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPC.catchItem = (short)ItemType<HummingBird2Item>();
	...
	internal class HummingBird2Item : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Ruby-Throated Hummingbird");
		...
		{ 
			...
			Item.makeNPC = (short)NPCType<HummingBird2>();
		}
	}
}