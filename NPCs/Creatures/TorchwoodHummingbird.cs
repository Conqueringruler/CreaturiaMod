...
namespace Creaturia.NPCs.Creatures
{
    ...
    internal class TorchwoodHummingbird : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPC.catchItem = (short)ItemType<TorchwoodHummingbirdItem>();
       ...
       /* public bool FindFlowersTop(int landX, int landY, out int flowerX, out int flowerY)
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
            ...
            {
                return SpawnCondition.OverworldDayBirdCritter.Chance * 0.01f;
            }
            else
            {
                return 0;
	...
	internal class TorchwoodHummingbirdItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Ruby-Throated Hummingbird");
		...
		public override void SetDefaults()
		{
			...
			Item.makeNPC = (short)NPCType<TorchwoodHummingbird>();
		}
	}
}