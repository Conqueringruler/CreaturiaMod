...
namespace Creaturia.NPCs.Creatures
{
    ...
    internal class Butter1Hummingbird : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            NPC.catchItem = (short)ItemType<ButterHummingbirdItem>();
       ...
       /* public bool FindFlowersTop(int landX, int landY, out int flowerX, out int flowerY)
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo)
		{
            ...
            {
                return SpawnCondition.OverworldDayBirdCritter.Chance * 5.75f;
            }
            else
            {
                return 0;
	...
	internal class ButterHummingbirdItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			// DisplayName.SetDefault("Ruby-Throated Hummingbird");
		...
		public override void SetDefaults()
		{
			...
			Item.makeNPC = (short)NPCType<Butter1Hummingbird>();
		}
	}
}